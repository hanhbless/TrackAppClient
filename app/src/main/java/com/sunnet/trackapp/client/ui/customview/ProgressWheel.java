package com.sunnet.trackapp.client.ui.customview;
...
public class ProgressWheel extends View {
    ...
    private int barLengthProgress = 60;
    ...
    private Handler spinHandler = new Handler() {
        /**
         * This is the dialCode that will increment the progress variable
    ...
    private void parseAttributes(TypedArray a) {
        ...
        barLengthProgress = (int) a.getDimension(R.styleable.ProgressWheel_barLengthProgress,
                barLengthProgress);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Draw the bar
        if (isSpinning) {
            canvas.drawArc(circleBounds, progress - 90, barLengthProgress, false,
                    barPaint);
        } else {
    ...
    public int getbarLengthProgress() {
        return barLengthProgress;
    }

    public void setbarLengthProgress(int barLengthProgress) {
        this.barLengthProgress = barLengthProgress;
    }
